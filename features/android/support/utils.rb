def turn_off_bluetooth
	# %x{adb shell service call bluetooth_manager 9 2>/dev/null}
	system "adb shell service call bluetooth_manager 9 2>/dev/null"
end

def turn_on_bluetooth
	# %x{adb shell service call bluetooth_manager 6 2>/dev/null}
...
def give_location_permission
	...
	# system "adb shell pm grant co.omisego.omgshop android.permission.ACCESS_COARSE_LOCATION"
end
